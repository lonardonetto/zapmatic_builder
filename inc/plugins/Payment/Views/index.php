            ...
            <div class=" overflow-hidden position-relative d-lg-block d-none h-100 w-600 ">
                <div class="payment-banner bg-primary p-50 d-flex justify-content-between align-items-center h-100">
                    <div class="m-b-200">
                        ...
                        <h1 class="text-white mb-4"><?php _e("Simplifique o Envio de Mensagens em Massa para WhatsApp")?></h1>
                        <div class="text-gray-200 fs-16">
                            <i class="fad fa-quote-left me-2"></i>
                            <?php _e("Gerenciar suas mensagens no WhatsApp nunca foi tão fácil. Nossa poderosa ferramenta permite criar, agendar e enviar mensagens em massa com apenas alguns cliques. Diga adeus à dificuldade de gerenciar múltiplos contatos no WhatsApp e olá à praticidade. Comece a simplificar o envio de suas mensagens hoje mesmo!")?>
