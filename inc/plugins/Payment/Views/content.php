<div class="payment-wrap w-100 h-100 overflow-auto">
    <div class="m-auto mw-800 py-5 px-4">
        <div class="mb-5 w-100">
            ...
            <h1 class="text-dark fs-30 text-gray-800"><?php _e( sprintf(__("Plano escolhido: %s"), $plan->name) )?></h1>
        ...
        <div class="row mb-4">
            <div class="col">
                <label class="border b-r-10 bg-white p-30 w-100 bg-hover-light-primary" for="bill_type_monthly">
                    <div class="d-flex justify-content-between">
                        <div class="fw-6 fs-16"><?php _e("Plano Mensal")?></div>
                        <div>
                    ...
                    <div class="text-gray-500 fs-12"><?php _ec( get_option("payment_symbol", "$") )?><?php _e( sprintf(__("%s/mensal"), $plan->amount_monthly) )?></div>
            ...
            <div class="col">
                <label class="border b-r-10 bg-white p-30 w-100 bg-hover-light-primary" for="bill_type_yearly">
                    <div class="d-flex justify-content-between">
                        <div class="fw-6 fs-16"><?php _e("Plano Anual")?></div>
                        <div>
                            <div class="form-check form-check-inline me-0">
                    ...
                    <div class="text-gray-500 fs-12"><?php _ec( get_option("payment_symbol", "$") )?><?php _e( sprintf(__("%s/anual"), $plan->amount_annually) )?></div>
                </label>
            </div>
        </div>
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-borderless mb-0">
                        ...
                        <?php endif ?>
                        <tr>
                            <td><?php _e("Pagamento imediato")?></td>
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-borderless mb-0">
                        <tr>
                            <td><?php _e("Subtotal")?></td>
                            <td class="text-end"><?php _ec( get_option("payment_symbol", "R$") )?><?php _e( sprintf("%s", $plan->price_annually_default) )?></td>
                        </tr>
                        <tr class="text-danger">
                            <td><?php _e("Annually plan discount")?></td>
                            <td class="text-end"><?php _ec( get_option("payment_symbol", "R$") )?><?php _e( sprintf("-%s", $plan->price_save) )?></td>
                        </tr>
                        <?php if ($plan->coupon): ?>
                            <tr class="text-danger">
                                <td><?php _e("Promotion")?></td>
                                <td class="text-end">-<?php _ec( get_option("payment_symbol", "R$") )?><?php _e( sprintf("%s", $plan->price_annually_coupon) )?></td>
                            </tr>
                        <?php endif ?>
                        <tr>
                            <td><?php _e("Pagamento imediato")?></td>
                            <td class="text-end fw-6 fs-18"><?php _ec( get_option("payment_symbol", "R$") )?><?php _e( sprintf("%s", $plan->amount_annually) )?></td>
                        </tr>
                    </table>
                </div>
            </div>
