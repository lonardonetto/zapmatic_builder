    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            ...
            <div class="mb-4">
                ...
                <input type="text" class="form-control form-control-solid" id="fm_allow_extensions" name="fm_allow_extensions" value="<?php _ec( get_option("fm_allow_extensions", "jpeg,gif,png,jpg,jfif,webp,avif,mp4,csv,pdf,mp3") )?>">
            </div>
