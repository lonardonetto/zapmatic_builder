...
$routes->get('', 'Whatsapp_leads::index');
$routes->match(['get','post'], 'ajax_list', 'Whatsapp_leads::ajax_list');
$routes->get('export', 'Whatsapp_leads::export');
$routes->post('delete', 'Whatsapp_leads::delete');
