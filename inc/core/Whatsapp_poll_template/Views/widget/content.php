<div class="tab-pane fade show <?php _ec( get_data($result, "type") == 4?"active":"" ) ?>" id="wa_poll">
    <label class="form-label"><?php _e("Poll templates")?></label>
                ...
                <div class="d-flex align-items-center align-self-center h-100 py-5">
                    <div class="w-100">
                        <div class="text-center px-4">
                            ...
                            <div>
                                <a class="btn btn-primary btn-sm b-r-30" href="<?php _e( base_url("whatsapp_poll_template/index/update") )?>" >
                                    <i class="fad fa-plus"></i> <?php _e("Add Poll template")?>
                                </a>
                            </div>
                        </div>
                    </div>
