<?php
namespace Core\Whatsapp_carousel_template\Models;

use CodeIgniter\Model;

class Whatsapp_carousel_templateModel extends Model
{
    protected $config;
    ...
    public function get_list($return_data = true)
    {
        ...
        $builder->select('*');
        $builder->where("( type = 5 AND team_id = '{$team_id}' )");
