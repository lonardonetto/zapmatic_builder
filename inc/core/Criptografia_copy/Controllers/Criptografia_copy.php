...
namespace Core\Criptografia_copy\Controllers;

use CodeIgniter\API\ResponseTrait;
use CodeIgniter\Controller;

class Criptografia_copy extends Controller
{
    use ResponseTrait;
    ...
    public function __construct()
    {
        ...
        $this->model = new \Core\Criptografia_copy\Models\Criptografia_copyModel();
    }

    public function index($page = false)
    {
        if (!permission("criptografia_copy")) {
        ...
        $data['content'] = view('Core\Criptografia_copy\Views\content', $data_content);
