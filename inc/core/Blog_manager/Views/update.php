				...
				<div class="row">
					<div class="col-md-8">
						...
						<div class="mb-4">
							...
							<div>
								<div class="form-check form-check-inline">
									<input class="form-check-input" type="radio" name="internal" <?php _ec((get_data($result, "internal") == 1 || get_data($result, "internal") == "") ? "checked='true'" : "") ?> id="internal_enable" value="1">
									<label class="form-check-label" for="internal_enable"><?php _e('Internal') ?></label>
								</div>
								<div class="form-check form-check-inline">
									<input class="form-check-input" type="radio" name="internal" <?php _ec((get_data($result, "internal") == 0) ? "checked='true'" : "") ?> id="internal_disable" value="0">
									<label class="form-check-label" for="internal_disable"><?php _e('Public') ?></label>
								</div>
							</div>
						</div>
						<div class="mb-3">
