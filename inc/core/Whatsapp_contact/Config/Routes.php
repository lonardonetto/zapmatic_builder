...
$routes->get('exportar_csv/all', 'Whatsapp_contact::exportar_csv/all');
$routes->get('exportar_csv/all/(:any)', 'Whatsapp_contact::exportar_csv/all/$1');
$routes->get('exportar_csv/(:any)', 'Whatsapp_contact::exportar_csv/$1');
$routes->get('exportar_csv/(:any)/(:any)', 'Whatsapp_contact::exportar_csv/$1/$2');