		...
		<div class="card mb-4">
			...
			<div class="card-body">
				<div class="row">
					...
					<div class="col-6">
						<div class="mb-3">
							<label class="form-label" for="sender_name"><?php _e("To Test")?></label>
							<input type="text" id="sender_test" name="sender_test" class="form-control form-control-solid" value="<?php _e( get_option("sender_test", "") )?>">
						</div>
					</div>
					<div class="col-6">
					    
						<a href="<?php _e( get_module_url('test/0') )?>" data-confirm="<?php _e("Are you sure to test this items?")?>" class="actionItem btn btn-warning mt-4" >
						<?php _e("Test Send Email")?>
						</a>
