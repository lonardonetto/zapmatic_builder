...
class WhatsappModel extends Model
{
    ...
    public function get_modules(){
        ...
        $modules_data_groups = array(); //ACRESCENTE ESSE TRECHO DE CÓDIGO
                        ...
                        foreach ( $model_files as $model_file )
                        {
                            ...
                            if ( in_array("block_whatsapp", $model_content) )
                                ...
                                switch ( strtolower( $config_item['parent']['id']) ) {
                                    ...
                                    case 'groups':
                                        $modules_data_groups[] = $data->block_whatsapp(); //ACRESCENTE ESSE TRECHO DE CÓDIGO
                                        break;   
        ...
        if( !empty($modules_data_feature) || !empty($modules_data_teplate) || !empty($modules_data_contact)){
            ...
            if(!empty($modules_data_groups)){ //ACRESCENTE ESSE TRECHO DE CÓDIGO
                uasort($modules_data_groups, function($a, $b) {
                    return $a['position'] <=> $b['position'];
                });
            }
            ...
            $modules_data[] = $modules_data_groups; //ACRESCENTE ESSE TRECHO DE CÓDIGO
