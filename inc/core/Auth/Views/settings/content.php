...
<div class="card mb-4">
		<div class="card-header">
			<div class="card-title"><?php _e("Sender OTP")?></div>
		</div>
		<div class="card-body">
			<div class="mb-4">
                <label for="otp_id_instacia" class="form-label"><?php _e('ID da instância')?></label>
                <input type="text" class="form-control form-control-solid" id="otp_id_instacia" name="otp_id_instacia" value="<?php _ec( get_option("otp_id_instacia", "") )?>">
            </div>
            <div class="mb-4">
                <label for="otp_id_token" class="form-label"><?php _e('Token de acesso')?></label>
                <input type="text" class="form-control form-control-solid" id="otp_id_token" name="otp_id_token" value="<?php _ec( get_option("otp_id_token", "") )?>">
            </div>
		</div>
	</div>
