...
(function (DragDropTouch_1) {
    ...
    var DragDropTouch = (function () {
        ...
        DragDropTouch.prototype._shouldHandlePressHoldMove = function (e) {
            return DragDropTouch._ISPRESSHOLDMODE &&
                this._isDragEnabled && e && e.touches && e.touches.length < 2;
        };
        ...
        DragDropTouch.prototype._getTarget = function (e) {
            var pt = this._getPoint(e, true), el = document.elementFromPoint(pt.x, pt.y);
        ...
        DragDropTouch.prototype._copyStyle = function (src, dst) {
            DragDropTouch._rmvAtts(dst.querySelectorAll('[id],[class],[style],[draggable]'));
            DragDropTouch._rmvAtts([dst]);
            var cs = getComputedStyle(src);
            var ds = dst.style;
            for (var i = 0; i < cs.length; i++) {
                var k = cs[i];
                if (k.indexOf('transition') < 0) {
                    ds[k] = cs[k];
                }
            }
        ...
        DragDropTouch._rmvAtts = function (nodeList) {
    ...
    DragDropTouch._KBDPROPS = ['altKey', 'ctrlKey', 'metaKey', 'shiftKey'];
    DragDropTouch._PTPROPS = ['pageX', 'pageY', 'clientX', 'clientY', 'screenX', 'screenY'];
