...
$flowName = 'COLETA_PROFISSIONAL_' . $timestamp;
$flowSlug = 'coleta_profissional_' . strtolower($timestamp);
...
$builderState = [
    ...
    'guided_menu' => [
        ...
        'items' => [
            [
                'id' => 'cadastro_prioritario',
                'title' => 'Cadastro prioritario',
                'description' => 'Atualizacao e validacao de dados',
                'metadata' => 'Email, telefone, cidade e informacoes basicas',
                'badge' => 'Rapido',
                'tags' => ['dados', 'cadastro'],
                'side_title' => '2 opcoes',
                'side_description' => 'Fluxo guiado',
                'image_data_url' => $imageDataUrls['cadastro'],
                'image_alt' => 'Categoria cadastro',
                'subitems' => [
                    [
                        'id' => 'atualizar_cadastro',
                        'title' => 'Atualizar cadastro',
                        'description' => 'Corrija nome, email, telefone ou cidade',
                        'metadata' => 'Ideal para base ja existente',
                        'detail_text' => 'Preencha os dados abaixo para atualizarmos o cadastro com seguranca e retornarmos com o historico certo.',
                        'image_data_url' => $imageDataUrls['cadastro'],
                        'image_alt' => 'Atualizacao cadastral',
                    ],
                    [
                        'id' => 'novo_cadastro',
                        'title' => 'Novo cadastro',
                        'description' => 'Solicite a criacao de um novo registro',
                        'metadata' => 'Ideal para novos clientes ou parceiros',
                        'detail_text' => 'Use este caminho para um novo cadastro. Nossa equipe fara a validacao e retornara com os proximos passos.',
                        'image_data_url' => $imageDataUrls['cadastro'],
                        'image_alt' => 'Novo cadastro',
                    ],
                ],
            ],
            [
                'id' => 'comercial_consultivo',
                'title' => 'Comercial consultivo',
                'description' => 'Propostas, demonstracao e interesse',
                'metadata' => 'Lead qualificado para retorno comercial',
                'badge' => 'Vendas',
                'tags' => ['lead', 'proposta'],
                'side_title' => '2 opcoes',
                'side_description' => 'Comercial',
                'image_data_url' => $imageDataUrls['comercial'],
                'image_alt' => 'Categoria comercial',
                'subitems' => [
                    [
                        'id' => 'solicitar_proposta',
                        'title' => 'Solicitar proposta',
                        'description' => 'Receba retorno comercial com contexto',
                        'metadata' => 'Objetivo, urgencia e empresa',
                        'detail_text' => 'Informe o maximo de contexto para nossa equipe comercial montar um retorno mais assertivo.',
                        'image_data_url' => $imageDataUrls['comercial'],
                        'image_alt' => 'Solicitacao de proposta',
                    ],
                    [
                        'id' => 'agendar_demonstracao',
                        'title' => 'Agendar demonstracao',
                        'description' => 'Marque uma apresentacao guiada',
                        'metadata' => 'Perfeito para avaliacao do produto',
                        'detail_text' => 'Coletamos seus dados e a preferencia de contato para organizar uma demonstracao mais objetiva.',
                        'image_data_url' => $imageDataUrls['comercial'],
                        'image_alt' => 'Agendamento de demonstracao',
                    ],
                ],
            ],
            [
                'id' => 'suporte_operacao',
                'title' => 'Suporte e operacao',
                'description' => 'Chamados, retorno tecnico e acompanhamento',
                'metadata' => 'Contexto tecnico antes do atendimento humano',
                'badge' => 'Suporte',
                'tags' => ['tecnico', 'retorno'],
                'side_title' => '2 opcoes',
                'side_description' => 'Suporte',
                'image_data_url' => $imageDataUrls['suporte'],
                'image_alt' => 'Categoria suporte',
                'subitems' => [
                    [
                        'id' => 'abrir_chamado',
                        'title' => 'Abrir chamado',
                        'description' => 'Registre o problema e seus dados',
                        'metadata' => 'Fluxo para ocorrencias e incidentes',
                        'detail_text' => 'Descreva o ocorrido e seus dados de contato para abrirmos o chamado com as informacoes certas.',
                        'image_data_url' => $imageDataUrls['suporte'],
                        'image_alt' => 'Abertura de chamado',
                    ],
                    [
                        'id' => 'pedir_retorno_tecnico',
                        'title' => 'Pedir retorno tecnico',
                        'description' => 'Solicite contato da equipe especializada',
                        'metadata' => 'Ideal para casos em analise',
                        'detail_text' => 'Preencha os campos e informe o melhor canal para retorno tecnico da equipe.',
                        'image_data_url' => $imageDataUrls['suporte'],
                        'image_alt' => 'Retorno tecnico',
                    ],
                ],
            ],
        ],
