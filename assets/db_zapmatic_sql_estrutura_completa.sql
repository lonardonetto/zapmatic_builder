...
) ENGINE=InnoDB AUTO_INCREMENT=101222 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sp_bb_versions` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_bot` (`bot_id`)
) ENGINE=InnoDB AUTO_INCREMENT=5207 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `sp_landing_pages`
--

DROP TABLE IF EXISTS `sp_landing_pages`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `sp_landing_pages` (
  ...
  `team_id` int(11) DEFAULT NULL,
  `title` varchar(255) NOT NULL COMMENT 'Nome interno da pagina',
  `slug` varchar(255) NOT NULL COMMENT 'URL amigavel',
  `page_type` varchar(50) NOT NULL DEFAULT 'custom' COMMENT 'home, pricing, faqs, features, custom',
...
--
-- Table structure for table `sp_landing_sections`
--

DROP TABLE IF EXISTS `sp_landing_sections`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `sp_landing_sections` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `page_id` int(11) NOT NULL COMMENT 'FK sp_landing_pages.id',
  `block_type` varchar(50) NOT NULL COMMENT 'hero, features, pricing, faq, testimonials, cta, footer, stats, blog, custom_html',
  `sort_order` int(11) DEFAULT '0',
  `title` varchar(255) DEFAULT NULL COMMENT 'Titulo interno da secao',
  `data` longtext COMMENT 'JSON com conteudo e configuracoes',
  `settings` longtext COMMENT 'JSON: css custom, padding, margem, fundo',
...
DROP TABLE IF EXISTS `sp_midtrans_history`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
...
DROP TABLE IF EXISTS `sp_whatsapp_ar_responses`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
...
DROP TABLE IF EXISTS `sp_whatsapp_callresponder`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
...
--
-- Table structure for table `sp_whatsapp_cloud_api_config`
--

DROP TABLE IF EXISTS `sp_whatsapp_cloud_api_config`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
...
DROP TABLE IF EXISTS `sp_whatsapp_delivery_reports`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
...
DROP TABLE IF EXISTS `sp_whatsapp_funnels`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
...
--
-- Table structure for table `sp_whatsapp_gateways`
--

DROP TABLE IF EXISTS `sp_whatsapp_gateways`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `sp_whatsapp_gateways` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `team_id` int(11) DEFAULT NULL,
  `instance_id` varchar(100) NOT NULL,
...
DROP TABLE IF EXISTS `sp_whatsapp_history`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
...
DROP TABLE IF EXISTS `sp_whatsapp_livechat`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
...
DROP TABLE IF EXISTS `sp_whatsapp_message_status`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
...
DROP TABLE IF EXISTS `sp_whatsapp_messages`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
...
DROP TABLE IF EXISTS `sp_whatsapp_quick_replies`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
...
CREATE TABLE `sp_whatsapp_schedules` (
  ...
  `created` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=166 DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sp_whatsapp_sessions` (
  ...
  `creds` longtext,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=1602 DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
DROP TABLE IF EXISTS `sp_whatsapp_subscriber`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
...
--
-- Dumping events for database 'db_zapmatic_sql'
--
...
-- Dump completed on 2026-08-13 18:01:37
